 ...
 */
extern THREAD_LOCAL const char program_name[];

/**
 * program birth year, defined by the program for show_banner()
 */
extern THREAD_LOCAL const int program_birth_year;

extern THREAD_LOCAL AVDictionary *sws_dict;
extern THREAD_LOCAL AVDictionary *swr_opts;
extern THREAD_LOCAL AVDictionary *format_opts, *codec_opts;
extern THREAD_LOCAL int hide_banner;
