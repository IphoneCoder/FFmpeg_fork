...
THREAD_LOCAL const char program_name[] = "ffprobe";
THREAD_LOCAL const int program_birth_year = 2007;

THREAD_LOCAL static int do_bitexact = 0;
THREAD_LOCAL static int do_count_frames = 0;
THREAD_LOCAL static int do_count_packets = 0;
THREAD_LOCAL static int do_read_frames  = 0;
THREAD_LOCAL static int do_read_packets = 0;
THREAD_LOCAL static int do_show_chapters = 0;
THREAD_LOCAL static int do_show_error   = 0;
THREAD_LOCAL static int do_show_format  = 0;
THREAD_LOCAL static int do_show_frames  = 0;
THREAD_LOCAL static int do_show_packets = 0;
THREAD_LOCAL static int do_show_programs = 0;
THREAD_LOCAL static int do_show_stream_groups = 0;
THREAD_LOCAL static int do_show_stream_group_components = 0;
THREAD_LOCAL static int do_show_streams = 0;
THREAD_LOCAL static int do_show_stream_disposition = 0;
THREAD_LOCAL static int do_show_stream_group_disposition = 0;
THREAD_LOCAL static int do_show_data    = 0;
THREAD_LOCAL static int do_show_program_version  = 0;
THREAD_LOCAL static int do_show_library_versions = 0;
THREAD_LOCAL static int do_show_pixel_formats = 0;
THREAD_LOCAL static int do_show_pixel_format_flags = 0;
THREAD_LOCAL static int do_show_pixel_format_components = 0;
THREAD_LOCAL static int do_show_log = 0;

THREAD_LOCAL static int do_show_chapter_tags = 0;
THREAD_LOCAL static int do_show_format_tags = 0;
THREAD_LOCAL static int do_show_frame_tags = 0;
THREAD_LOCAL static int do_show_program_tags = 0;
THREAD_LOCAL static int do_show_stream_group_tags = 0;
THREAD_LOCAL static int do_show_stream_tags = 0;
THREAD_LOCAL static int do_show_packet_tags = 0;

THREAD_LOCAL static int show_value_unit              = 0;
THREAD_LOCAL static int use_value_prefix             = 0;
THREAD_LOCAL static int use_byte_value_binary_prefix = 0;
THREAD_LOCAL static int use_value_sexagesimal_format = 0;
THREAD_LOCAL static int show_private_data            = 1;

#define SHOW_OPTIONAL_FIELDS_AUTO       -1
#define SHOW_OPTIONAL_FIELDS_NEVER       0
#define SHOW_OPTIONAL_FIELDS_ALWAYS      1
THREAD_LOCAL static int show_optional_fields = SHOW_OPTIONAL_FIELDS_AUTO;

THREAD_LOCAL static char *output_format;
THREAD_LOCAL static char *stream_specifier;
THREAD_LOCAL static char *show_data_hash;
...
THREAD_LOCAL static ReadInterval *read_intervals;
THREAD_LOCAL static int read_intervals_nb = 0;

THREAD_LOCAL static int find_stream_info  = 1;
...
THREAD_LOCAL static const OptionDef *options;

/* FFprobe context */
THREAD_LOCAL static const char *input_filename;
THREAD_LOCAL static const char *print_input_filename;
THREAD_LOCAL static const AVInputFormat *iformat = NULL;
THREAD_LOCAL static const char *output_filename = NULL;

THREAD_LOCAL static struct AVHashContext *hash;
...
THREAD_LOCAL static const char unit_second_str[]         = "s"    ;
THREAD_LOCAL static const char unit_hertz_str[]          = "Hz"   ;
THREAD_LOCAL static const char unit_byte_str[]           = "byte" ;
THREAD_LOCAL static const char unit_bit_per_second_str[] = "bit/s";

THREAD_LOCAL static int nb_streams;
THREAD_LOCAL static uint64_t *nb_streams_packets;
THREAD_LOCAL static uint64_t *nb_streams_frames;
THREAD_LOCAL static int *selected_streams;

#if HAVE_THREADS
THREAD_LOCAL pthread_mutex_t log_mutex;
#endif
...
THREAD_LOCAL static LogBuffer *log_buffer;
THREAD_LOCAL static int log_buffer_size;
