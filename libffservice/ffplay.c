...
#define THREAD_LOCAL   
THREAD_LOCAL const char ffplay_program_name[] = "ffplay";
THREAD_LOCAL const int ffplay_program_birth_year = 2003;
...
THREAD_LOCAL static const AVInputFormat *file_iformat;
THREAD_LOCAL static const char *input_filename;
THREAD_LOCAL static const char *window_title;
THREAD_LOCAL static int default_width  = 640;
THREAD_LOCAL static int default_height = 480;
THREAD_LOCAL static int screen_width  = 0;
THREAD_LOCAL static int screen_height = 0;
THREAD_LOCAL static int screen_left = SDL_WINDOWPOS_CENTERED;
THREAD_LOCAL static int screen_top = SDL_WINDOWPOS_CENTERED;
THREAD_LOCAL static int audio_disable;
THREAD_LOCAL static int video_disable;
THREAD_LOCAL static int subtitle_disable;
THREAD_LOCAL static const char* wanted_stream_spec[AVMEDIA_TYPE_NB] = {0};
THREAD_LOCAL static int seek_by_bytes = -1;
THREAD_LOCAL static float seek_interval = 10;
THREAD_LOCAL static int display_disable;
THREAD_LOCAL static int borderless;
THREAD_LOCAL static int alwaysontop;
THREAD_LOCAL static int startup_volume = 100;
THREAD_LOCAL static int show_status = -1;
THREAD_LOCAL static int av_sync_type = AV_SYNC_AUDIO_MASTER;
THREAD_LOCAL static int64_t start_time = AV_NOPTS_VALUE;
THREAD_LOCAL static int64_t duration = AV_NOPTS_VALUE;
THREAD_LOCAL static int fast = 0;
THREAD_LOCAL static int genpts = 0;
THREAD_LOCAL static int lowres = 0;
THREAD_LOCAL static int decoder_reorder_pts = -1;
THREAD_LOCAL static int autoexit;
THREAD_LOCAL static int exit_on_keydown;
THREAD_LOCAL static int exit_on_mousedown;
THREAD_LOCAL static int loop = 1;
THREAD_LOCAL static int framedrop = -1;
THREAD_LOCAL static int infinite_buffer = -1;
THREAD_LOCAL static enum ShowMode show_mode = SHOW_MODE_NONE;
THREAD_LOCAL static const char *audio_codec_name;
THREAD_LOCAL static const char *subtitle_codec_name;
THREAD_LOCAL static const char *video_codec_name;
THREAD_LOCAL double rdftspeed = 0.02;
THREAD_LOCAL static int64_t cursor_last_shown;
THREAD_LOCAL static int cursor_hidden = 0;
THREAD_LOCAL static const char **vfilters_list = NULL;
THREAD_LOCAL static int nb_vfilters = 0;
THREAD_LOCAL static char *afilters = NULL;
THREAD_LOCAL static int autorotate = 1;
THREAD_LOCAL static int find_stream_info = 1;
THREAD_LOCAL static int filter_nbthreads = 0;
THREAD_LOCAL static int enable_vulkan = 0;
THREAD_LOCAL static char *vulkan_params = NULL;
THREAD_LOCAL static const char *hwaccel = NULL;
...
THREAD_LOCAL static const OptionDef *options = NULL;
...
static void ffplay_show_help_default(const char *opt, const char *arg)
{
...
void global_ffplay_init_options(void)
{
    ...
    options = av_malloc(sizeof(tmp_options));
